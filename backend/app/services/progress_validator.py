class ProgressValidator:
    ...
    def validate(self, old_state: dict, new_state: dict) -> dict:
        ...
        self._validate_resources(old_state, new_state, errors)
        self._validate_player(old_state, new_state, errors)
        self._validate_progress(old_state, new_state, errors)
        self._validate_skills(old_state, new_state, errors)
        self._validate_map(old_state, new_state, errors)
    ...
    def _validate_resources(self, old_state: dict, new_state: dict, errors: list[str]) -> None:
    ...
    def _validate_progress(self, old_state: dict, new_state: dict, errors: list[str]) -> None:
        ...
        elif new_cleared and old_cleared:
    ...
    def _validate_map(self, old_state: dict, new_state: dict, errors: list[str]) -> None:
