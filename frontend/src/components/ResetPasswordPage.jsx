...
function ResetPasswordPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await authApi.resetPassword({ username, new_password: newPassword })
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="card-game max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-academic-purple mb-2">🔑 重置密码</h1>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-500">
            <Link to="/" className="text-campus-blue font-semibold hover:underline">返回登录</Link>
          </p>
        </div>
      </div>
    </div>
